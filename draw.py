...
def draw_polygons( polygons, screen, color ):
    ...
    while i < len(polygons):
        add_edge(edgeM, polygons[i][0], polygons[i][1], polygons[i][2], polygons[i+1][0], polygons[i+1][1], polygons[i+1][2])
        add_edge(edgeM, polygons[i+1][0], polygons[i+1][1], polygons[i+1][2], polygons[i+2][0], polygons[i+2][1], polygons[i+2][2])
        add_edge(edgeM, polygons[i+2][0], polygons[i+2][1], polygons[i+2][2],polygons[i][0], polygons[i][1], polygons[i][2])
        i += 3
    draw_lines(edgeM, screen, color)
